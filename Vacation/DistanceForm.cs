    ...
    public partial class DistanceForm : MaterialForm
    {
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch (comboBox1.SelectedItem)
            {
                ...
                case "山西":
                    comboBox2.Items.Clear();
                    comboBox2.Items.AddRange(new object[] { "太原", "大同", "运城", "长治", "晋城", "忻州", "临汾", "吕梁", "晋中", "阳泉", "朔州","古交","潞城", "高平", "原平", "孝义", "离石", "汾阳", "榆次", "介休", "侯马", "霍州", "永济", "河津" , "广灵", "文水", "临猗", "盂县", "夏县", "洪洞", "闻喜", "柳林", "五寨" });
                    break;
                case "辽宁":
                    comboBox2.Items.Clear();
                ...
                case "广西壮族自治区":
                    comboBox2.Items.Clear();
                    comboBox2.Items.AddRange(new object[] { "贵港", "玉林", "北海", "南宁", "柳州", "桂林", "梧州", "钦州", "来宾", "崇左", "防城港","岑溪","东兴","桂平", "北流", "凭祥", "合山", "贺州", "百色", "河池", "宜州", "融水", "灌阳" });
                    break;
                case "澳门特别行政区":
                    comboBox2.Items.Clear();
        ...
        private void comboBox4_SelectedIndexChanged(object sender, EventArgs e)
        {
            switch (comboBox4.SelectedItem)
            {
                ...
                case "山西":
                    comboBox3.Items.Clear();
                    comboBox3.Items.AddRange(new object[] { "太原", "大同", "运城", "长治", "晋城", "忻州", "临汾", "吕梁", "晋中", "阳泉", "朔州", "古交", "潞城", "高平", "原平", "孝义", "离石", "汾阳", "榆次", "介休", "侯马", "霍州", "永济", "河津", "广灵", "文水", "临猗", "盂县", "夏县", "洪洞", "闻喜", "柳林", "五寨" });
                    break;
                case "辽宁":
                    comboBox3.Items.Clear();
                ...
                case "广西壮族自治区":
                    comboBox3.Items.Clear();
                    comboBox3.Items.AddRange(new object[] { "贵港", "玉林", "北海", "南宁", "柳州", "桂林", "梧州", "钦州", "来宾", "崇左", "防城港", "岑溪", "东兴", "桂平", "北流", "凭祥", "合山", "贺州", "百色", "河池", "宜州", "融水", "灌阳" });
                    break;
                case "澳门特别行政区":
                    comboBox3.Items.Clear();
